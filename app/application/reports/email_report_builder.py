...
def render_html_email(data: ReportData, recipient_name: str = "") -> str:
  ...
  <tr>
    <td style="background:#0f172a;border-radius:0 0 12px 12px;
      ...
      <p style="margin:0;font-size:11px;color:#334155">
        ...
        &nbsp;·&nbsp;
        To update your preferences, contact your RMIAS administrator.
      </p>
    </td>
  </tr>
...
async def send_frequency_report(
    ...
    for rec in recipients:
        try:
            html_body = render_html_email(data, recipient_name=rec.name)
            await sender.send(
