"""One-shot dry run for Nova 96.9 — radio-australia.org weekly chart collector.

Fetches the static weekly chart from radio-australia.org/nova-969.
...
Usage (inside the running app container):
    docker exec rmias-app-1 python -m app.tools.dry_run_nova_radio_australia
"""
...
_URL = "https://www.radio-australia.org/nova-969"
_DUMP_PATH = Path("/tmp/nova_radio_australia_raw.html")
